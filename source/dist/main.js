parcelRequire = function(e, r, t, n) {
	...
	"jSg4": [function(require, module, exports) { !
		function(e) {
			...
			e(".local-search").size() && e.getScript("/js/search.js",
			function() {
	...
	"BNiz": [function(require, module, exports) {
		...
		var c = function() {
			...
			if (e && 0 !== e.length) {
				...
				"" === o || /^(http:|https:)?\/\//.test(o) || (o = window.location.origin + o),
				...
				document.querySelector(".modal-close").onclick = s
			}
		};
		c();
	},
